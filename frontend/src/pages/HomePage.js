    ...
    <div data-testid="home-page">
      ...
      <section data-testid="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-cream/60 via-cream/50 to-cream" />
        </div>
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={0} className="text-xs uppercase tracking-[0.3em] text-coffee/70 mb-6 font-medium">
            Est. 2024 &mdash; Premium Artisan Bakery
          </motion.p>
          <motion.h1 variants={fadeUp} initial="hidden" animate="visible" custom={1} className="font-serif text-5xl sm:text-6xl lg:text-7xl font-medium text-coffee leading-[1.1] mb-6">
            Luxury Bakery<br />Crafted with Perfection
          </motion.h1>
          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={2} className="text-charcoal/60 text-base sm:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
      ...
      <section data-testid="features-section" className="py-24 px-6 bg-cream">
        <div className="max-w-6xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
            <motion.p variants={fadeUp} custom={0} className="text-xs uppercase tracking-[0.2em] text-sage-dark font-medium mb-3">Why Choose Us</motion.p>
            <motion.h2 variants={fadeUp} custom={1} className="font-serif text-3xl sm:text-4xl lg:text-5xl text-coffee">The Sunehri Promise</motion.h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={f.title} variants={fadeUp} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                className="soft-card p-8 text-center group" data-testid={`feature-card-${i}`}>
      ...
      {signatures.length > 0 && (
        <section data-testid="signature-section" className="py-24 px-6 bg-beige/30">
          <div className="max-w-6xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
              <motion.p variants={fadeUp} custom={0} className="text-xs uppercase tracking-[0.2em] text-sage-dark font-medium mb-3">Our Best</motion.p>
              <motion.h2 variants={fadeUp} custom={1} className="font-serif text-3xl sm:text-4xl lg:text-5xl text-coffee">Signature Collection</motion.h2>
            </motion.div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {signatures.map((item, i) => (
                <motion.div key={item.id} variants={fadeUp} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                  className="soft-card overflow-hidden group" data-testid={`signature-item-${i}`}>
      ...
      <section data-testid="about-section" className="py-24 px-6 bg-cream">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <motion.p variants={fadeUp} custom={0} className="text-xs uppercase tracking-[0.2em] text-sage-dark font-medium mb-3">Our Story</motion.p>
            <motion.h2 variants={fadeUp} custom={1} className="font-serif text-3xl sm:text-4xl text-coffee mb-6">A Legacy of Golden Perfection</motion.h2>
            <motion.p variants={fadeUp} custom={2} className="text-charcoal/60 leading-relaxed mb-4">
            ...
            <motion.p variants={fadeUp} custom={3} className="text-charcoal/60 leading-relaxed">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="img-zoom overflow-hidden rounded-2xl shadow-soft-lg">
      ...
      {reviews.length > 0 && (
        <section data-testid="testimonials-section" className="py-24 px-6 bg-beige/30">
          <div className="max-w-6xl mx-auto">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
              <motion.p variants={fadeUp} custom={0} className="text-xs uppercase tracking-[0.2em] text-sage-dark font-medium mb-3">Testimonials</motion.p>
              <motion.h2 variants={fadeUp} custom={1} className="font-serif text-3xl sm:text-4xl lg:text-5xl text-coffee">What Our Guests Say</motion.h2>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {reviews.map((r, i) => (
                <motion.div key={r.id} variants={fadeUp} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }}
                  className="soft-card p-8" data-testid={`testimonial-${i}`}>
